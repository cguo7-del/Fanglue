...
# 先在Git仓库中提交变更，然后保存到本地文档的脚本

# 显示帮助信息
show_help() {
    echo "使用方法: ./git_commit_and_backup.sh [选项] <提交信息>"
    echo ""
    echo "选项:"
    echo "  -h, --help     显示帮助信息"
    ...
    echo ""
    echo "示例:"
    echo "  ./git_commit_and_backup.sh -m \"添加新功能\""
    echo "  ./git_commit_and_backup.sh -b ~/my_backups -m \"修复bug\""
}
...
echo "完成! 更改已提交到Git仓库并保存到本地备份。"
echo "Git提交信息: $COMMIT_MESSAGE"
